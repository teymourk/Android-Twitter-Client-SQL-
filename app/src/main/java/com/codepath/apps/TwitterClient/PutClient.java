...
public class PutClient {
    ...
    public void updateBio(String text) {
        ...
        RestApplication.getRestClient().update_user_bio(text, new JsonHttpResponseHandler() {
    ...
    public void makeTweet(String text) {
        ...
        RestApplication.getRestClient().post_tweet(text, new JsonHttpResponseHandler() {
